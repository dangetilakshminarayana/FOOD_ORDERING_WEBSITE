...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
    ...
    <a class="navbar-brand" href="index.php"><span style="color:green;font-family: 'Permanent Marker', cursive;">Hungry Birds</span></a>
    <?php
	if(!empty($cust_id))
	{
	?>
...
<div class="container-fluid">
  <img src="img/about-plan.jpg" width="100%">
</div>
<br>
<div class="container">
  <div class="row">
    ...
    <div class="col-sm-4" style="padding:30px;">
	   <div class="form-group">
           <i class="fa fa-phone" aria-hidden="true"></i>&nbsp;<b>+141 123456789</b><br><br>
			<i class="fa fa-home" aria-hidden="true"></i>&nbsp; 23-A ,India,<br>Punjab,Jalandhar<br>Zip Code-144411<br>(24*7 Days)
