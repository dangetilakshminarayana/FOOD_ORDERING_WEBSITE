...
<div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="img/banner41.jpg" alt="Los Angeles" class="d-block w-100">
    ...
    <div class="carousel-item">
      <img src="img/banner111.jpg" alt="Chicago" class="d-block w-100">
      <div class="carousel-caption">
        <h3>India</h3>
        <p>Thank you, India!</p>
      </div>   
    ...
    <div class="carousel-item">
      <img src="img/banner2.jpg" alt="New York" class="d-block w-100">
      <div class="carousel-caption">
        <h3>Rolls</h3>
        <p>We love the Rolls</p>
      </div>   
    </div>
  </div>
